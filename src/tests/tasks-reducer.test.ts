...
import { tasksActions } from '../components/todolists/tasks';
import { tasksReducer } from '../components/todolists/tasks/bll/tasks-reducer';

const { updateTaskAC, removeTaskAC, setTasksAC, addTaskAC } = tasksActions;
const { setTodoListsAC } = todoListActions;
