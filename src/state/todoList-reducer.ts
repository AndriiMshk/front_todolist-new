...
type ChangeTodoListTitleACType = ReturnType<typeof changeTitleTodoListAC>
...
export const setTodoListsAC = (todoLists: TodoListType[]) => ({ type: 'SET-TODOLISTS',
  payload: todoLists } as const);
